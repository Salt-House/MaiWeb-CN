...
const qaData: QAItem[] = [
  ...
  },
  {
    ...
    question: "如何联系技术支持？",
    answer:
      "您可以通过以下方式联系技术支持：1) 闲聊群反馈：734304941；2) 联系开发者：2544733927；3) 发送邮件：e2544733@outlook.com",
    category: "客服支持",
  },
]
...
export default function QAPage() {
  ...
  const filteredQA =
    selectedCategory === "全部" ? qaData : qaData.filter(item => item.category === selectedCategory)
    ...
    <div className="min-h-screen">
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold text-gray-800 mb-4">常见问题</h1>
