...
import SongChecklist, { preloadSongs } from "@/components/common/SongChecklist"
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative">
          <div className="border-4 border-white bg-white rounded-2xl">
            <div className="bg-white/80 backdrop-blur-md rounded-2xl overflow-hidden border-4 border-pink-300">
              {/* Content Section */}
              <div className="p-8">
                <div className="mb-6">
                  <h1 className="text-3xl font-bold text-gray-800 mb-4">
                    KALEIDXSCOPE: Phase #1 青の扉 (青之门)
                  </h1>
                </div>
                ...
                <div className="prose prose-lg max-w-none text-gray-800">
                    ...
                    {isSpoilerOpen && (
                      ...
                      >
                        <div className="pt-2">
                          ...
                          <h2 className="text-2xl font-bold mt-8 mb-4 text-pink-500">基本信息</h2>
                          <p className="mb-4">
                          ...
                          <h2 className="text-2xl font-bold mt-8 mb-4 text-pink-500">机制</h2>
                          <p className="mb-4">
                          ...
                          <h3 className="text-xl font-bold mt-6 mb-3 text-pink-400">路线规则：</h3>
                          <ul className="list-disc pl-5 mb-4 space-y-2">
                  ...
                  <h2 className="text-2xl font-bold mt-8 mb-4 text-pink-500">Phase #1: 青の扉 (青之门)</h2>
                  <div className="bg-pink-50 p-6 rounded-xl border border-pink-200 mb-6">
                    <ul className="space-y-2">
                      <li><strong>解锁区域：</strong> スカイストリートちほー6 (天空街区域 6)</li>
                      <li><strong>解锁曲目：</strong> 
                      <Link
                      ...
                      <li><strong>艺术家：</strong> TAKU1175 ft.駄々子</li>
                      <li><strong>对应区域：</strong> 天空街区域</li>
                    </ul>
                  </div>

                  <h3 className="text-xl font-bold mt-6 mb-3 text-pink-400">青之门解锁条件</h3>
                  <p className="mb-4">
                    完走 <span className="font-bold">天空街区域6</span>
                  </p>

                  <h3 className="text-xl font-bold mt-6 mb-3 text-pink-400">钥匙获取条件</h3>
                  <div className="mb-6">
                    <div
                      className="flex items-center justify-between bg-blue-50 p-4 rounded-lg border border-blue-200 cursor-pointer hover:bg-blue-100 transition-colors mb-4"
                      onClick={() => setIsKeyListOpen(!isKeyListOpen)}
                    >
                      <p className="font-bold text-blue-500 m-0">
                        以 任意难度 游玩下列29首 天空街区域 歌曲：
                      </p>
                      {isKeyListOpen ? (
                  ...
                  <h3 className="text-xl font-bold mt-6 mb-3 text-pink-400">完走条件</h3>

                  <div className="mb-6 bg-pink-50 p-6 rounded-xl border border-pink-200">
                    <ul className="space-y-3">
                      <li className="flex items-start">
                        <span className="font-bold text-pink-600 min-w-[80px]">Track 1:</span>
                        <span>23首 <span className="font-bold text-pink-500">天空街区域</span> 歌曲 （除完美挑战曲）中 随机一首</span>
                      </li>
                      <li className="flex items-start">
                        <span className="font-bold text-pink-600 min-w-[80px]">Track 2:</span>
                        <span>6首 <span className="font-bold text-pink-500">天空街区域 完美挑战</span> 歌曲 中随机一首</span>
                      </li>
                      <li className="flex items-start">
                        <span className="font-bold text-pink-600 min-w-[80px]">Track 3:</span>
                        <span>
                          <Link
                            href={`${CONFIG.API.WEB.MUSIC}/1740`}
                            target="_blank"
                    ...
                    <table className="min-w-full bg-white border border-gray-200 rounded-lg">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td className="py-2 px-4 border-b">Master</td>
                          <td className="py-2 px-4 border-b">更新首日</td>
                          <td className="py-2 px-4 border-b">2026/1/23</td>
                        </tr>
                        <tr>
                          <td className="py-2 px-4 border-b">10</td>
                          <td className="py-2 px-4 border-b">Master</td>
                          <td className="py-2 px-4 border-b">3天后</td>
                          <td className="py-2 px-4 border-b">2026/1/26</td>
                        </tr>
                        <tr>
                          <td className="py-2 px-4 border-b">30</td>
                          <td className="py-2 px-4 border-b">Master</td>
                          <td className="py-2 px-4 border-b">6天后</td>
                          <td className="py-2 px-4 border-b">2026/1/29</td>
                        </tr>
                        <tr>
                          <td className="py-2 px-4 border-b">50</td>
                          <td className="py-2 px-4 border-b">Master</td>
                          <td className="py-2 px-4 border-b">9天后</td>
                          <td className="py-2 px-4 border-b">2026/2/1</td>
                        </tr>
                        <tr>
                          <td className="py-2 px-4 border-b">100</td>
                          <td className="py-2 px-4 border-b">Expert</td>
                          <td className="py-2 px-4 border-b">13天后</td>
                          <td className="py-2 px-4 border-b">2026/2/5</td>
                        </tr>
                        <tr>
                          <td className="py-2 px-4 border-b">999</td>
                          <td className="py-2 px-4 border-b">任意难度</td>
                          <td className="py-2 px-4 border-b">20天后</td>
                          <td className="py-2 px-4 border-b">2026/2/12</td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
