          ...
          {areas.length === 0 ? (
            ...
            <div className="w-full max-w-7xl space-y-8">
              {Object.entries(groupAreasByPrefix(areas))
                ...
                <div key={groupKey} className="bg-pink-800/20 backdrop-blur-sm rounded-xl p-6 border border-pink-300/30 shadow-lg">
                  {/* 分组标题 */}
                  <div 
                    className="flex items-center justify-between cursor-pointer mb-4 hover:bg-pink-700/30 rounded-lg p-2 transition-all"
