      ...
      >
        ...
        <div className="hidden sm:flex items-center max-sm:space-x-3 space-x-4 justify-center text-2xl text-white font-bold">
          <motion.div whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.95 }}>
            <Link id="music" href={"/music"} className="hover:scale-125 transition-all duration-300 ease-in-out text-pink-500 hover:text-pink-600" style={textstroke}>音乐</Link>
          </motion.div>
          <div className="text-pink-300">|</div>
          <motion.div whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.95 }}>
            <Link id="region" href={"/region"} className="hover:scale-125 transition-all duration-300 ease-in-out text-pink-500 hover:text-pink-600" style={textstroke}>区域</Link>
          </motion.div>
          <div className="text-pink-300">|</div>
          <motion.div whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.95 }}>
            <Link id="tool" href={"/tool"} className="hover:scale-125 transition-all duration-300 ease-in-out text-pink-500 hover:text-pink-600" style={textstroke}>工具</Link>
          </motion.div>
          <div className="text-pink-300">|</div>
          <motion.div whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.95 }}>
            <Link id="qa" href={"/qa"} className="hover:scale-125 transition-all duration-300 ease-in-out text-pink-500 hover:text-pink-600" style={textstroke}>常见问题</Link>
          </motion.div>
          <div className="text-pink-300">|</div>
          <motion.div whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.95 }}>
            <Link id="road" href={"/road"} className="hover:scale-125 transition-all duration-300 ease-in-out text-pink-500 hover:text-pink-600" style={textstroke}>开发路线</Link>
          </motion.div>
          {/* <div>|</div> */}
