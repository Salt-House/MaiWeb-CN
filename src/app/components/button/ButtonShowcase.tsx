    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-200 via-purple-200 to-pink-200 p-8">
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <section className="bg-white/60 backdrop-blur-sm rounded-2xl p-6">
          ...
          <div className="flex flex-wrap gap-4">
            <Button variant="gradient" leftIcon={<FaPlay />}>播放音乐</Button>
            <Button variant="accent" rightIcon={<FaHeart />}>收藏</Button>
            <Button variant="secondary" leftIcon={<FaDownload />} rightIcon={<FaArrowRight />}>
              下载文件
            </Button>
            <Button variant="outline" leftIcon={<FaSearch />}>搜索</Button>
            <Button variant="primary" leftIcon={<FaUser />}>个人中心</Button>
          </div>
        </section>
        ...
        <section className="bg-white/60 backdrop-blur-sm rounded-2xl p-6">
          ...
          <div className="flex flex-wrap gap-4">
            <Button variant="primary" rounded>圆形主要</Button>
            <Button variant="gradient" rounded>圆形渐变</Button>
