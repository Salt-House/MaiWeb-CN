...
const Button: React.FC<ButtonProps> = ({
  ...
  // 基础样式
  let baseClasses = 'inline-flex items-center justify-center font-medium transition-all duration-200 ';
  ...
  switch (variant) {
    case 'primary':
      ...
      break;
    case 'secondary':
      variantClasses = 'bg-gradient-to-r from-blue-400 to-purple-500 text-white border-2 border-white/20 ';
      ...
      break;
    case 'accent':
      variantClasses = 'bg-gradient-to-r from-pink-400 to-orange-400 text-white border-2 border-white/30 ';
    ...
    case 'gradient':
      ...
      variantClasses += 'active:from-blue-600 active:via-purple-700 active:to-pink-600 focus:ring-purple-300';
      break;
    case 'outline':
