...
const SearchGameCenter = () => {
    ...
    return (
        <>
            ...
            <div id="searchGameCenter" className="relative my-10 max-sm:w-[410px] w-[800px] mx-auto flex flex-col justify-center items-center rounded-2xl overflow-visible">
                {/* 多层边框背景 - 保持原设计风格 */}
