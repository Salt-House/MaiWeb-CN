...
export default function SongDetail() {
    ...
    return (
        <div className="min-h-screen p-4 sm:p-8 ">
            ...
            >
                <div className="mb-6">
                    <Link href='/music' className="inline-flex items-center text-gray-600 hover:text-pink-500 transition-colors group">
 ...
 * 谱面类型切换组件
 */
function ChartTypeSwitcher({ chartType, setChartType }: { chartType: ChartType, setChartType: (type: ChartType) => void }) {
    const tabs = [
    ...
    return (
        <div className='relative w-full max-w-xs aspect-square'>
            <motion.div
                ...
                whileHover={{ scale: 1.03, boxShadow: '16px 16px 32px rgba(0,0,0,0.15), -16px -16px 32px rgba(255,255,255,1)' }}
                whileTap={{ scale: 0.99, boxShadow: '6px 6px 12px rgba(0,0,0,0.05), -6px -6px 12px rgba(255,255,255,0.7)' }}
                ...
                <div className='relative w-full h-full rounded-full'>
                    ...
                    <div
                        ...
                        style={{
                            ...
                            boxShadow: 'inset 8px 8px 16px rgba(0,0,0,0.05), inset -8px -8px 16px rgba(255,255,255,0.3)'
                        }}
                    />
                    ...
                    <div
                        ...
                        style={{
                            ...
                            boxShadow: 'inset 4px 4px 8px rgba(0,0,0,0.1), inset -4px -4px 8px rgba(255,255,255,0.2)'
                        }}
                    />
                    ...
                    <div
                        ...
                        style={{
                            ...
                            boxShadow: 'inset 3px 3px 6px rgba(0,0,0,0.06), inset -3px -3px 6px rgba(255,255,255,0.6)'
                        }}
                    />
                </div>
