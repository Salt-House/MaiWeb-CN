...
function SongListLegacy({
  ...
  return (
    <div className="border-1 border-white bg-white rounded-2xl p-2 m-2">
      <div className="border-4 border-pink-300 bg-white rounded-2xl flex-col w-full max-sm:px-2 justify-center items-center p-4 max-sm:p-0">
        ...
        {loading ? (
          ...
          songs.map((song, index) => (
            <>
              <div
                id="clickDetail"
                className="relative mb-10 max-sm:mb-1"
                key={`${song.id}-${index}`}
              >
                <a
