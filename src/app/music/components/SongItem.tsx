        ...
        >
            ...
            >
                ...
                <motion.div
                    ...
                    whileHover={{ scale: 1.03, boxShadow: '12px 12px 24px rgba(190,24,93,0.45), -12px -12px 24px rgba(249,168,212,0.7)' }}
                    whileTap={{ scale: 0.99, boxShadow: '4px 4px 8px rgba(190,24,93,0.25), -4px -4px 8px rgba(249,168,212,0.5)' }}
                    ...
                    <div className='relative w-full h-full rounded-full'>
                        ...
                        <div
                            ...
                            style={{
                                ...
                                boxShadow: 'inset 6px 6px 12px rgba(190,24,93,0.20), inset -6px -6px 12px rgba(249,168,212,0.30)'
                            }}
                        />
                        ...
                        <div
                            ...
                            style={{
                                ...
                                boxShadow: 'inset 3px 3px 6px rgba(190,24,93,0.16), inset -3px -3px 6px rgba(249,168,212,0.24)'
                            }}
                        />
