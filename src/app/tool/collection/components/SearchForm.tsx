      ...
      >
        ...
        >
          <div className="flex-1">
            <label className="block text-sm font-medium text-gray-700 mb-2">搜索名称</label>
            <input
              type="text"
              value={searchTerm}
          ...
          {activeTab === "trophy" && (
            <div className="flex-1">
              <label className="block text-sm font-medium text-gray-700 mb-2">颜色筛选</label>
              <select
                value={searchColor}
          ...
          <div className="flex-1">
            <label className="block text-sm font-medium text-gray-700 mb-2">Genre筛选</label>
            <select
              value={searchGenre}
