            ...
            <div className="border-4 border-white rounded-2xl">
              <div className="relative max-sm:w-[400px] w-[900px] max-sm:px-2 bg-white/85 rounded-2xl px-10 flex flex-col text-center border-4 border-[rgb(155,244,236)] text-black">
                {isLoading ? <LoadingSpinner /> : <>
                  ...
                  <div className="flex-row flex w-full items-center justify-center mb-2 mt-5">
                    <hr className='w-full border-t-4 border-gray-300 my-5 rounded-full' />
                    <div className="whitespace-nowrap px-7 text-gray-700 font-bold text-2xl">个人全国行脚图</div>
                    <hr className='w-full border-t-4 border-gray-300 my-5 rounded-full' />
                  </div>
                  ...
                  <div className="flex flex-col justify-center m-6 mx-16 mb-16 space-y-8">
                    ...
                    <button className="inline-flex items-center justify-between rounded-2xl bg-blue-500 p-3 px-4 text-white font-bold w-full" onClick={() => setActiveSection('隐私设置')}>
                      <div className="flex items-center">
                    ...
                    <button className="inline-flex items-center justify-between rounded-2xl bg-red-500 p-3 px-4 text-white font-bold w-full" onClick={LogOut}>
                      <div className="flex items-center">
                ...
                <div className="relative max-sm:w-[400px] max-sm:px-0 w-[900px] bg-white/85 rounded-2xl px-10 flex flex-col text-center border-4 border-[rgb(155,244,236)] text-black min-h-96">
                  {isLoading ? <LoadingSpinner /> : <>
                    ...
                    <div className="flex justify-center m-3 mb-10">
                      <button className="right-10 ml-2 rounded-2xl bg-purple-500 p-3 px-4 text-white font-bold inline-block" onClick={GetBindAccount}>更新绑定状态</button>
                    </div>
            ...
            <div className="border-4 border-white rounded-2xl">
              <div className="relative max-sm:w-[400px] max-sm:px-0 w-[900px] bg-white/85 rounded-2xl px-10 flex flex-col text-center border-4 border-[rgb(155,244,236)] text-black">
                {isLoading ? <><LoadingSpinner /></> : <>
                  <div className="flex-row flex w-full items-center justify-center mb-2 mt-5">
                    <hr className='w-full border-t-4 border-gray-300 my-5 rounded-full' />
                    <div className="whitespace-nowrap px-7 text-gray-700 font-bold text-2xl">隐私设置</div>
                    <hr className='w-full border-t-4 border-gray-300 my-5 rounded-full' />
                  </div>
    ...
    <div className='w-[900px] max-sm:w-[420px] h-auto rounded-2xl mt-10 mx-auto flex flex-col justify-center items-center'>
      {/* <div className='w-[700px] h-24  bg-white/30 backdrop-blur-md rounded-xl text-black font-bold flex justify-center items-center mb-5'>
        <ul className='flex flex-row justify-center items-center space-x-5 text-xl'>
          <li><a href='#'
            className={activeSection === "基本信息" ? "text-purple-600" : ""}
            onClick={() => setActiveSection("基本信息")}>基本信息</a></li>
          <li>|</li>
          <li><a href='#'
            className={activeSection === "关联账号" ? "text-purple-600" : ""}
            onClick={() => setActiveSection("关联账号")}>关联账号</a></li>
          <li>|</li>
          <li><a href='#'
            className={activeSection === "隐私设置" ? "text-purple-600" : ""}
            onClick={() => setActiveSection("隐私设置")}>隐私设置</a></li>
          <li>|</li>
          <li><a href='#'
            className={activeSection === "else" ? "text-purple-600" : ""}
            onClick={() => setActiveSection("else")}>else</a></li>
          <li>|</li>
          <li><button
